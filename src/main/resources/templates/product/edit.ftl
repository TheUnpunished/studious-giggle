...
<div class="form-style-2">
    <form method="post" action="/product/edit/${product.id}">
        <div class="field">
            ...
            <input type="text" name="name" id="name" class="input-field" value="${product.name}">
        </div>
        <div class="field">
            <label for="price">
                Цена
            </label>
            <input type="number" name="price" id="price" class="input-field" step=".01" min="0.01" value="${product.price}">
        </div>
        <div class="field">
            <label for="count">
                Количество
            </label>
            <input type="number" name="count" id="count" class="input-field" value="${product.count}">
        </div>
        <div class="field">
            <label for="shop.id">
                Адрес магазина
